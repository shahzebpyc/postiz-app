export default function PrivacyPolicy() {
    return (
        <div className="min-h-screen bg-[#0E0E0E] text-white p-8 max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold mb-8">Privacy Policy</h1>

            <div className="space-y-6 text-gray-300 leading-relaxed">
                <p className="border-b border-gray-800 pb-4">
                    At Vinsmoke Media (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;), we are committed to protecting the privacy and security of our users&rsquo; personal information. This Privacy Policy outlines how we collect, use, and safeguard the personal information collected on our website. By accessing or using our website, registering for the Website, and providing your personal information, you agree to the terms and conditions of this Privacy Policy.
                </p>

                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">1. Our Services</h2>
                    <h3 className="text-lg font-medium text-white mb-1">Vinsmoke Media Services</h3>
                    <p>Vinsmoke Media&rsquo;s suite of social media management and social care tools is accessible via our websites and mobile applications. These tools allow you to combine all your social media accounts for easy access and management through a single online platform. Through this platform, you can manage your social media, marketing, and advertising campaigns, engage with your audiences, schedule and publish messages, manage customer care communications, and analyze the results of these activities.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Social Networks</h3>
                    <p>Any collection, use, and management of personal information by the social networks, including Facebook, Instagram, Twitter, LinkedIn, and TikTok (collectively, the &ldquo;Social Networks&rdquo;) are governed by their respective privacy policies and terms. When using Social Networks, you must comply with their privacy policies and terms. We recommend carefully reviewing their privacy policies and terms, as Vinsmoke Media is not responsible for Social Networks.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Your Privacy Obligations</h3>
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Business Purposes</h3>
                ...
                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">2. What information do we collect?</h2>
                    <p>We collect information about you as reasonably necessary for the following activities:</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Using our Services</h3>
                    <p>We may collect the following information when you use our Services:</p>

                    <ul className="list-disc pl-5 mt-2 space-y-2">
                        <li>
                            <strong className="text-white">Account information:</strong> Your contact and profile information, including your name, email address, organization name, and address; your preferences such as language, time zone, and the types of communications you would like to receive from us; and image (if you choose to provide this). We may also obtain this information if you use a social login service like Facebook Login to create or access your account.
                        ...
                        <li>
                            <strong className="text-white">Logs, usage, and support data:</strong>
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Surveys, events, marketing, and other activities</h3>
                    ...
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                        ...
                        <li>General information about the organization you choose to provide includes annual company revenue, number of employees, and industry. We may also use service providers to obtain additional business-related information about your organization, such as the legal name, size, and publicly available revenue, to assist us in offering services appropriate to your organization&rsquo;s needs.</li>
                    </ul>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Other interactions:</h3>
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Browsing our websites</h3>
                    ...
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                        ...
                        <li>Vinsmoke Media and our authorized service providers use cookies and similar tracking technologies, including web beacons, pixels, and software tokens, on our websites and services.</li>
                ...
                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">3. How do we use your information?</h2>
                    <p>We use your information for the purposes described below:</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Providing and securing our Services</h3>
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Communicating with you</h3>
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Improving our websites and applications</h3>
                ...
                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">4. What are your rights regarding the information about you?</h2>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Services information</h3>
                    ...
                    <p>If you have requests that cannot be carried out by logging in to your account, such as accessing additional information or deleting information about you, for the Vinsmoke Media services, please email our privacy team. Please note that we may need to retain certain information about you for as long as you maintain an account for our Services, to provide you with our Services, for record keeping purposes, for payment processing, to comply with our legal and regulatory obligations, to resolve disputes, or to enforce the Vinsmoke Media terms of service, or other agreement in place between you (or your organization) and Vinsmoke Media (collectively, the &ldquo;Terms of Service&rdquo;).</p>
                    <p>Requests to access, correct, update, or delete your information can be made in writing to our privacy team and will be handled within thirty (30) days unless they are unusually extensive or complex, in which case we will advise you of the expected timeline for handling your request.</p>
                    <p>If you have authorized us to access your Social Network account to provide the Services, you may revoke this access at any time by emailing our support team here. For example, if you have authorized us to access your information via the YouTube API services, in addition to our normal procedure for deleting stored data, you may revoke our access to your data via the Google security settings page, located here.</p>
                    <p>You can contact our Support team for other general requests here.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Marketing emails, advertising and website browsing</h3>
                    <p>For marketing communications, you may opt out of marketing communications sent by Vinsmoke Media by accessing by clicking on the unsubscribe link in the marketing email you receive. Please note that if you are a Vinsmoke Media user, unsubscribing from marketing communications will not affect product-generated emails sent in connection with your use of our Services.</p>
                    <p>Vinsmoke Media participates in interest-based advertising (where you may have visited our websites or another website which allows us to display advertising relating to our Services). The Network Advertising Initiative has developed a tool that may help you understand which third parties have currently enabled cookies for your browser and how to opt out of those cookies. For more information and to opt out of interest-based advertising, you can visit this page.</p>
                    <p>For more information on how to opt out of marketing cookies, review our Cookie Notice.</p>
                </section>

                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">5. Who has access to your information?</h2>
                    <p>Vinsmoke Media does not rent or sell your information. We restrict access to your information to authorized employees and we do not share your information with third parties except in the circumstances explained below.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Authorized Contractors</h3>
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Service Providers, Authorized Resellers, and Partners</h3>
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Social Networks and Third-Party Services</h3>
                    <p>Where you are using our Services and have chosen to connect your Social Networks to the Services, or if you authorize a Third-Party Service to access your account, you are agreeing to provide information about you to the Social Networks and the Third-Party Services under their respective terms and privacy policies. For example, if you choose to connect your YouTube account to the Services, this connection uses YouTube&rsquo;s API services, and the Google Privacy Policy (located here) will apply to you.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Customer Organizations</h3>
                    <p>Where your employer or an entity has purchased Services on your behalf, we may disclose information about you such as your name and email address, and some usage information including whether a user has logged in to the Service, frequency of login, time spent using the Services, and enrollment and completion of Vinsmoke Media Academy courses to assist your employer or the entity in managing its use and maximizing the value of the Services.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Successor and Affiliated Entities</h3>
                    <p>We may share information about you among Vinsmoke Media-controlled affiliates and subsidiaries, and they will protect your information in a manner that is consistent with this Privacy Policy and where applicable, in accordance with the privacy policy specific to the entity.</p>
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Law Enforcement, Government Agencies, and Professional Advisors</h3>
                ...
                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">6. What international data transfers occur at Vinsmoke Media?</h2>
                ...
                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">7. How do we safeguard your information?</h2>
                    <p>Vinsmoke Media maintains industry standard security safeguards to protect your information. This includes ensuring our employees receive appropriate security and privacy training and guidance so they are aware of the measures they need to implement to protect your information.</p>
                ...
                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">9. Vinsmoke Media&rsquo;s roles under the GDPR and UK data protection laws</h2>
                    <p>Depending on the situation and the type of data involved, Vinsmoke Media may act as a data controller or a data processor.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Vinsmoke Media as a data controller</h3>
                    <p>Vinsmoke Media may act as a data controller when we are:</p>
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                        <li>Collecting information from you to set up and administer your Vinsmoke Media account (for example, Account information such as your name and email address);</li>
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Legal bases for processing when Vinsmoke Media is a data controller</h3>
                    ...
                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Your rights when Vinsmoke Media is a data controller</h3>
                    <p>Where Vinsmoke Media is acting as a data controller, we have outlined certain rights in the &ldquo;What are your privacy rights?&rdquo; section.</p>
                    <p>In addition, you may have the following rights:</p>
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                        <li>Right to object to processing: You may request that Vinsmoke Media stop processing information about you (for example, stop sending you marketing communications).</li>
                        ...
                        <li>Right to data portability: You may request that we provide you with information Vinsmoke Media has about you in a structured, machine-readable, and commonly used format or transfer this information to another data controller.</li>
                    </ul>
                    <p>If you would like assistance on any of the above requests, please email our Privacy team.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Vinsmoke Media as a data processor</h3>
                    <p>When you use our Services and make decisions about the personal data being processed in them (including selecting the Social Network accounts you wish to connect to the Services or uploading and using Content), you are acting as a data controller, and Vinsmoke Media is acting as a data processor.</p>
                    <p>As a data controller, you have certain obligations under the GDPR, including managing Content on the Services. As a data processor, Vinsmoke Media will only access and process Content to provide you with the Services by your instructions (which you provide through the Services), the Terms of Service, the Social Networks&rsquo; terms, and applicable laws. As part of delivering the Services, we may process Content to improve further the Services, such as enhancing usability and developing new features.</p>
                    <p>As a data controller, suppose you require Vinsmoke Media to agree to data protection requirements under Article 28, GDPR, or UK data protection laws. In that case, Vinsmoke Media makes available a data processing addendum that meets these requirements.</p>
                    <p>If you are using the Services as an authorized user of a Vinsmoke Media customer (whether that customer is your employer, another organization, or an individual), that customer determines its own policies (if any) regarding storage, access, modification, deletion, sharing, and retention of personal data and Content, which may apply to your use of the Services. Please check with that customer about the policies and settings it has in place.</p>
                </section>

                <section>
                    <h2 className="text-xl font-semibold text-white mb-2">10. Your California Privacy Rights</h2>
                    <p>Suppose you are a consumer as defined in the California Consumer Privacy Act (CCPA) and as amended by the California Privacy Rights Act (CPRA) (collectively, &ldquo;California Privacy Laws&rsquo;). In that case, the following provisions apply to you. Definitions of terms are set out in the California Privacy Laws.</p>

                    <h3 className="text-lg font-medium text-white mt-4 mb-1">Your Rights</h3>
                    ...
                    <p>You may access, update, or correct most of your Account information by logging in to your account; or you may exercise your rights by emailing our Privacy team.</p>
